...
const { x: xCoord, y: yCoord, z: zCoord } = coordinates;
...
const { first, second, ...others } = locations;
...
const { upper, middle = "default position", lower } = doorCode;
...
console.log(translation, modernWord);
...
const [firstElement, secondElement, thirdElement, fourthElement] = elements;
...
console.log(firstshadow, hiddenShadows);
...
function revealPath(direction, distance) {
     console.log(`Move ${distance} in the ${direction} direction.`);
}

revealPath("North", "15 feet");
